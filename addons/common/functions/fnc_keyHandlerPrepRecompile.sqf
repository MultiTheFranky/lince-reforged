...
/*
    ...
    *
    * Example:
    * call lince_common_fnc_keyHandlerPrepRecompile;
    *
    * Public: No
*/
...
["Lince", "lince_common_preprecompile", ["Prep Recompile Key", "This key will execute [] call ACE_PREP_RECOMPILE; every time that you press it"], {
